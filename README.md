...
el programa le aparecera un menu que tendra 2 opciones, 1. Start game, 2. Exit Game
...
run the program it going to appear a menu that will have 2 options, 1. Start game, 2.Exit Game. 
For start to play you just have to insert 1 and press enter, soon it will be creat a board full of pieces, the white pieces are
